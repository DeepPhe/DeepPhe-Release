...
final public class DpheListAnnotator extends JCasAnnotator_ImplBase {

   static private final Logger LOGGER = Logger.getLogger( "DpheListAnnotator" );
   ...
   static private Map<Pair<Integer>, ListType> getUniqueListTypes( final Map<Pair<Integer>, ListType> listTypes ) {
      ...
      while ( true ) {
         final List<Pair<Integer>> sortedBounds = listTypes.keySet().stream()
                                                           .sorted( ( p1, p2 ) -> (p2.getValue2() - p2.getValue1()) -
                                                                                  (p1.getValue2() - p1.getValue1()) )
