...
import org.apache.ctakes.dictionary.lookup.cased.util.bsv.BsvObjectCreator;
import org.apache.ctakes.dictionary.lookup.cased.util.tokenize.RareWordUtil;
import org.apache.ctakes.dictionary.lookup.cased.util.tokenize.TokenizedTerm;
...
final public class BsvDictionary implements CasedDictionary {
   ...
   public BsvDictionary( final String name, final String bsvPath ) {
      ...
      final Map<String, Collection<CandidateTerm>> candidateTermMap = RareWordUtil.createTermMap( tokenizedTerms );
      _delegateDictionary = new InMemoryDictionary( name, candidateTermMap );
   }
