...
import org.apache.ctakes.dictionary.lookup.cased.wsd.WsdUtil;
...
//      SUBSUME_MAP.put( PHENOMENON, EnumSet.of( ENTITY ) );
   ...
   public void createAnnotations( final JCas jCas,
      ...
      final Map<SemanticGroup, Collection<DiscoveredTerm>> semanticTermsMap
            = AnnotationCreatorUtil.mapSemanticTerms( detailsMap, reassignSemantics );
      ...
      allDiscoveredTermsMap.forEach(
            ( k, v ) -> AnnotationCreatorUtil.createAnnotations( jCas, k, v, detailsMap, reassignSemantics ) );
   }
