package org.apache.ctakes.dictionary.lookup.cased.util.jdbc;
...
final public class JdbcUtil {
   ...
   static public final String SYNONYMS_TABLE = "SYNONYMS";
   static public final String DETAILS_TABLE = "DETAILS";
