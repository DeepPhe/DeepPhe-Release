 ...
 * @since 9/4/2020
 */
public enum PatientSummaryNodeStore implements ObjectStore<PatientSummary> {
   INSTANCE;

   public static PatientSummaryNodeStore getInstance() {
      return INSTANCE;
   }


   private final ObjectStore<PatientSummary> _delegate;


   PatientSummaryNodeStore() {
   ...
   public PatientSummary get( final String patientId ) {
      return _delegate.get( patientId );
   }

   public boolean add( final String patientId, final PatientSummary patient ) {
