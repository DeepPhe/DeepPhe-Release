...
//      final MedicalRecord medicalRecord = MedicalRecordStore.getInstance().pop( getEngineName() );
...
//      }
//
//      final Collection<CancerSummary> cancers = medicalRecord.getCancerSummaries();
//      for ( CancerSummary cancer : cancers ) {
//         if ( !cancer.isEmpty() ) {
...
//      }
//      LOGGER.info( "Create Fact node " + getNiceId( instance ) + " for instance " + instance.getId() );
...
//      try ( Transaction tx = graphDb.beginTx() ) {
//
//         LOGGER.info( "Creating Fact node " + factId );
...
//    */
//   static private String getNiceId( final ConceptInstance instance ) {
//      return getTrimUri( instance.getUri() ) + '_' + instance.getPatientId() + '_' + instance.hashCode();
//   }
//
//   /**
//    * @return [uri]_[PatientId]_[DocId]_[SemanticGroup]_[HashCode]
//    */
//   static private String getNiceId( final Fact fact ) {
//      return getTrimUri( fact.getUri() ) + '_' + fact.getPatientIdentifier() + '_' + fact.hashCode();
//   }
//
