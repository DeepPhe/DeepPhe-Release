...
public class FHIRConstants {
   ...
   static {
      EPISODE_TYPE_MAP.put( "Diagnositc", EPISODE_DIAGNOSTIC );
      EPISODE_TYPE_MAP.put( "Pre-Diagnositc", EPISODE_PREDIAGNOSTIC );
   ...
   public static final String CLOCKFACE_POSITION = "ClockfacePosition";
   public static final String UNIT = "Unit";
   public static final String TNM_MODIFIER = "TNM_Modifier";
   public static final String HAS_BODY_SITE = "hasBodySite";
   public static final String HAS_LATERALITY = "hasLaterality";
   ...
   public static final URI EPISODE_URI = URI.create( MODEL_CANCER_URL + "#" + EPISODE );
