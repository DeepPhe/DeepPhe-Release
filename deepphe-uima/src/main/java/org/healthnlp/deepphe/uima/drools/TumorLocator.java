...
public class TumorLocator {
   ...
   private Set<String> bodySiteAnsestors = null;

   private boolean readyForRetraction = false;

   public Set<String> getBodySiteAnsestors() {
      if ( bodySiteAnsestors == null )
         bodySiteAnsestors = new LinkedHashSet<String>();
      return bodySiteAnsestors;
   }

   public void setBodySiteAnsestors( Set<String> ancestors ) {
      getBodySiteAnsestors().addAll( ancestors );
   }
   ...
   public void setTumorSiteFact( Fact tumorSiteFact ) {
      ...
      setBodySiteAnsestors( tumorSiteFact.getAncestors() );
   }
